...
const StatFetcher = require('../../../controllers/github-request/languages-stats');
...
module.exports = class UserLanguagesGetApi extends API {
	...
	async process() {
		...
		try {
			...
			const repositoriesStats = await StatFetcher.get(this.pathIds);
